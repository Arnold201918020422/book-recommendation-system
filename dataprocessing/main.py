...
Users_data = pd.read_csv("/Users/chengfujia/Desktop/bookdata/BX-Users.csv", sep=';', names=u_cols, encoding='latin-1',low_memory=False, na_values=" NaN", on_bad_lines='skip')

#Books

i_cols = ['isbn', 'book_title' ,'book_author','year_of_publication', 'publisher', 'img_s', 'img_m', 'img_l']
Books_data = pd.read_csv("/Users/chengfujia/Desktop/bookdata/BX-Books.csv",  sep=';', names=i_cols, encoding='latin-1',low_memory=False,na_values=" NaN", on_bad_lines='skip')

#Ratings

r_cols = ['user_id', 'isbn', 'rating']
Ratings_data = pd.read_csv("/Users/chengfujia/Desktop/bookdata/BX-Book-Ratings.csv",  sep=';', names=r_cols, encoding='latin-1',low_memory=False,  on_bad_lines='skip')
